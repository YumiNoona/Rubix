...
object PuzzleCapturePlans {
 ...
 val all=listOf(
  ...
  PuzzleCapturePlan(PuzzleId.PYRAMINX,"Keep one vertex pointing upward for each guided face.",(1..4).map { CaptureStep("face-$it","Triangle $it","Show all nine triangular facelets and three edges.",9) }),
